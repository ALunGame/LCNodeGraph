    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue(Type inst_type, JsonReader reader)
        {
                ...
                reader.Token == JsonToken.Boolean)
            {
                ...
                Debug.LogError($"指定的转换出错 {reader.Value} {json_type} {inst_type}");
                return null;
            }
            ...
            else if (reader.Token == JsonToken.ObjectStart)
            {
                ...
                if (objType == null)
                {
                    Debug.LogError($"序列化类出错，没有找到指定的类 {typeFullName}");
                    //丢弃序列化
                    while (true)
                    {
                        reader.Read();
                ...
                ObjectMetadata t_data = object_metadata[objType];
                                        ...
                                        int depth)
        {
            ...
            {
                writer.WriteObjectStart(obj.GetType());
            ...
            writer.WriteObjectStart(obj_type);
            //writer.WriteObjectType(obj_type);
