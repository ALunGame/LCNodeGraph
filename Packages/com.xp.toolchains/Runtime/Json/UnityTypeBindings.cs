using System;
using UnityEngine;
using XPToolchains.Json.Extensions;
...
namespace XPToolchains.Json
{
    ...
    public static class UnityTypeBindings
    {
        ...
        public static void Register()
        {
            ...
            // 注册int类型与string
            JsonMapper.RegisterExporter<string>((v, w) =>
            {
                w.Write(v);
            });

            JsonMapper.RegisterImporter<int, string>((s) =>
            {
                return s.ToString();
            });
            ...
            {
                w.WriteObjectStart(typeof(Vector2));
            ...
            {
                w.WriteObjectStart(typeof(Vector3));
                w.WriteProperty("x", v.x);
                w.WriteProperty("y", v.y);
            ...
            {
                w.WriteObjectStart(typeof(Vector4));
                w.WriteProperty("x", v.x);
                w.WriteProperty("y", v.y);
                w.WriteProperty("z", v.z);
            ...
            {
                w.WriteObjectStart(typeof(Quaternion));
                w.WriteProperty("x", v.x);
                w.WriteProperty("y", v.y);
                w.WriteProperty("z", v.z);
                w.WriteProperty("w", v.w);
            ...
            {
                w.WriteObjectStart(typeof(Color));
            ...
            {
                w.WriteObjectStart(typeof(Color32));
                w.WriteProperty("r", v.r);
                w.WriteProperty("g", v.g);
                w.WriteProperty("b", v.b);
                w.WriteProperty("a", v.a);
            ...
            {
                w.WriteObjectStart(typeof(Bounds));
            ...
            {
                w.WriteObjectStart(typeof(Rect));
                w.WriteProperty("x", v.x);
                w.WriteProperty("y", v.y);
            ...
            {
                w.WriteObjectStart(typeof(RectOffset));
